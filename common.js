...
var Render = {
  ...
  player: function(ctx, width, height, resolution, roadWidth, sprites, speedPercent, scale, destX, destY, steer, updown, handBreaking, lightSpeed) {
    ...
    if (steer < 0)
      if (lightSpeed) {
        sprite = (updown > 0) ? SPRITES.PLAYER_LIGHTSPEED_UPHILL_LEFT : SPRITES.PLAYER_LIGHTSPEED_LEFT;
      } else {
...
var COLORS = {
  ...
  TREE: '#111113',
  FOG:  '#262729',
  LIGHT:  { road: '#313335', grass: '#258288', rumble: '#f7f7f7', lane: '#cdcfd1' },
  DARK:   { road: '#262729', grass: '#176C77', rumble: '#ebebeb' },
  START:  { road: '#ebebeb', grass: '#258288', rumble: '#cdcfd1' },
  FINISH: { road: '#f4c40e', grass: '#fece35', rumble: '#e6b10d' }
};
